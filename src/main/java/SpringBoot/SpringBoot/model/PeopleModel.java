...
public class PeopleModel {
    ...
    public PeopleModel(int id, String login, String password, String name, String secondName, String gender, String age, String seriesPassport, String numberPassport, String telephone, String er) {
        this.id = id;
        this.login = login;
